...
)
{
    ...
    Logger_set(LOG_LEVEL_DEBUG, "statement_parse, statement_parseSubstitute, statement_parseFunctionCall, expression_parse, expression_parseParametersExpression, expression_parsePlusMinus, expression_parseMultiplyDivide, expression_parseFactor, expression_parseReferenceExpression, expression_parseVariable, reference_parse, reference_variable, executor_executeSubstituteStatement, executor_executeStatement, executor_executeFunctionCallStatement, evaluator_reference, evaluator_referenceVariable, variableDefinition_search");

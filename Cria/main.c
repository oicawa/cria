...
)
{
    ...
    Logger_set(LOG_LEVEL_DEBUG, "statement_parseFunctionCall, expression_parseReferenceExpression, expression_parseVariable, expression_parseFunctionCall, expression_parseParametersExpression");

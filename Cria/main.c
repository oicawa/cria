...
)
{
    ...
    Logger_set(LOG_LEVEL_DEBUG, "ExpressionVariable_evaluateFromParameters, ExpressionVariable_evaluateFromObject, DefinitionClass_generateInstance, CriaObject_set, DefinitionFunction_evaluate");
